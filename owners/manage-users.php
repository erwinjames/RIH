...
{				?>		
						  <tr>
							...
							<td><?php echo htmlentities($result->mid_name);?></td>
							<td><?php echo htmlentities($result->tel_number);?></td>
							<td><?php echo htmlentities($result->pre_address);?></td>
							<td><?php echo htmlentities($result->email_address);?></td>
							<td><img width="10%" src="pacakgeimages/<?php echo htmlentities($result->profiles);?>"></img></td>
						  </tr>
						 <?php $cnt=$cnt+1;} }?>
						</tbody>
					  </table>
