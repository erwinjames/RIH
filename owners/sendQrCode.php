...
$sqls="INSERT INTO tblqrmessage(bookings_id,owner_email,users_email,qr) VALUES(:bookId,:owners_identitys,:emails,:qrcodes)";
$querys= $dbh->prepare($sqls);
$querys->bindParam(':bookId',$bookId,PDO::PARAM_STR);
$querys->bindParam(':owners_identitys',$owners_identity,PDO::PARAM_STR);
$querys->bindParam(':emails',$user_email,PDO::PARAM_STR);
$querys->bindParam(':qrcodes',$qrcode,PDO::PARAM_STR);
$querys->execute();
$lastInsertId = $dbh->lastInsertId();
if($lastInsertId)
{
$msg="sunccesfully send";
}
else 
{
