...
?></td>
<td>
<?php $payMethod=htmlentities($result->paymentMethod);
if ($payMethod=="gcash") {
...
<?php if($result->status==2)
{
	?><td>Cancelled</td>
<?php } else {?>
<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to cancel booking')" >Cancel</a> / <a href="manage-bookings.php?emailto=<?php echo htmlentities($result->email);?>&&bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to cancel booking')" >Confirm</a></td>
<?php }?>
