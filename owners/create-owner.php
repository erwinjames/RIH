...
$sql="INSERT INTO tblowners(first_name,last_name,mid_name,tel_number,pre_address,email_address,profiles) VALUES(:fname,:lname,:mname,:telNum,:presAdd,:emailAdd,:pimage)";
