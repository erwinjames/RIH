					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li id="menu-academico" ><a href="#"><i class="fa fa-users" aria-hidden="true"></i>
									<span>Users</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
									<ul id="menu-academico-sub" >
										   <li id="menu-academico-avaliacoes" ><a href="create-owner.php">Create Owner</a></li>
											<li id="menu-academico-avaliacoes" ><a href="manage-users.php">Users</a></li>
										  </ul>
									</li>
									
									<li><a href="manage-bookings.php"><i class="fa fa-list" aria-hidden="true"></i>  <span>Manage Booking</span><div class="clearfix"></div></a></li>
									<li><a href="manage-packages.php"><i class="fa fa-list" aria-hidden="true"></i>  <span>Manage Boats</span><div class="clearfix"></div></a></li>
