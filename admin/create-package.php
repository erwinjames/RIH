...
$sql="INSERT INTO TblTourPackages(PackageName,address,contact_num,boat_name,boat_operator,boat_capacity,pricePerpack,PackageLocation,PackagePrice,PackageFetures,offer_price,PackageDetails,PackageImage) VALUES(:pname,:addres,:contact,:boatName,:boatOperator,:boatCapacity,:pricePerpack ,:plocation,:pprice,:pfeatures,:OfferPrice,:pdetails,:pimage)";
							...
							<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<label for="focusedinput" class="control-label">Boat Capacity</label>
										<input type="text" class="form-control1" name="boatCapacity" id="boatCapacity" placeholder="Boat Capacity" required>
									</div>
									<div class="col-sm-6">
									<label for="focusedinput" class="control-label">Price per 1 pack</label>
